...
function Get-LatestRelease {
    try {
        $releases = Invoke-RestMethod -Uri 'https://api.github.com/repos/macieqz/releases'
...
function RedirectToLatestPreRelease {
    ...
    if ($latestRelease) {
        $url = "https://github.com/Cmacieqz/winutil/releases/download/$latestRelease/winutil.ps1"
    } else {
        ...
        $url = "https://github.com/Cmacieqz/winutil/releases/latest/download/winutil.ps1"
    }
